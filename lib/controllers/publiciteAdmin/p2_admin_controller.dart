...
abstract class Informations2ControllerAdmin extends GetxController {
  goToPublicite(String regionI , String emplacementI);
  goToPublicite1();
  creerCompte();
}
class Informations2ControllerAdminImp extends Informations2ControllerAdmin {
  late String region;
  ...
  goToPublicite(String regionI , String emplacementI) async {
    try {
      ...
      if (iduser !=0) {
        ...
        print(description);
        print(categor);
        Get.toNamed(AppRoutes.publicite3Admin, arguments: {
